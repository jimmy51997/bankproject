...
if (!window['google']['loader']) {
    ...
    (function() {
        ...
        google.loader.f = function(a, b, c) {
            var d;
            a: {
                if ((d = g.document.querySelector("script[nonce]")) && (d = d.nonce || d.getAttribute("nonce")) && x.test(d)) break a;d = void 0
            }
            if (c) {
                if ("script" == a) {
                ...
                a ? (e = '<script src="' + w(b) + '" type="text/javascript"', d && (e += ' nonce="' + w(d) + '"'), document.write(e + ">\x3c/script>")) : "css" == a && (e = '<link href="' + w(b) + '" type="text/css" rel="stylesheet"', d && (e += ' nonce="' + w(d) + '"'), document.write(e + "></link>"))
        };
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/4aa0772189af4c17ea7ec181af2bca15/",
            "js": "default+en.I.js",
            "css": "default+en.css",
            "properties": {
                ":Version": "1.0",
                ":NoOldNames": false,
                ":JSHash": "4aa0772189af4c17ea7ec181af2bca15"
            }
        },
        ":language": {
            "versions": {
